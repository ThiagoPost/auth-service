...
return [
    ...
    'info' => [
         ...
         */
        'description' => <<<'DESC'
# API de Autenticação - Serviço Centralizado
...
A maioria dos endpoints requer autenticação via Bearer Token. Para obter um token, faça login usando o endpoint `/api/auth/login`.
...
DESC,
    ...
    'ui' => [
         ...
         */
        'title' => 'API de Autenticação - Documentação',
        ...
        /*
         * UI renderer. Available options: 'elements' (Stoplight Elements)
         * Nota: Scalar pode ser usado carregando o JSON OpenAPI em uma instância separada do Scalar
         */
        // 'renderer' => 'elements', // Padrão
    ...
    'middleware' => [
        'web',
        // RestrictedDocsAccess::class, // Desabilitado para permitir acesso público à documentação
    ],
